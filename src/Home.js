    ...
    <div>
      <div className="header">
        ...
        <nav>
          <ul className="nav-items">
            <button className="w3-btn w3-round-xxlarge" onClick={executeScroll}>Services </button>
      ...
      <div>
        <div className="green-background">
          ...
          <p className="text-properties">“CS Flowers Design is composed by a new and dynamic team witch main goal is centered in turning your dreams becoming real. Creating emotions in every moment.
            Focused on floral art, we work in general decoration, fiancee bouquets and weeding
            accessories".
          </p>
